...
game:GetService("StarterGui"):SetCore(
    "SendNotification",
    {Title = "Frederico Dev Menu", Text = "Discord: https://discord.gg/AmE6eRjtzM"}
)
game:GetService("StarterGui"):SetCore(
    "SendNotification",
    {Title = "Frederico Dev Menu", Text = "Please donate to us if you like the menu!"}
)
...
E.Text = "Frederico Dev | Universal Roblox Menu | F4 to Toggle"
